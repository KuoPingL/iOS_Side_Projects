...
- (void)setupLeftBarItem {
    ...
    if(@available(iOS 11.0, *)){
        [[_menuBtn .widthAnchor constraintEqualToConstant:_barItemHeight] setActive:true];
    }
...
- (void)setupRightBarItem {
    ...
    if (@available(iOS 11.0, *)){
        [[_searchBtn.widthAnchor constraintEqualToConstant:_barItemHeight] setActive:true];
    }
