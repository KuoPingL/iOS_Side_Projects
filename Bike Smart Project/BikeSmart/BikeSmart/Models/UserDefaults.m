...
#pragma mark - Cluster Width
+ (void)setClusterItemWidth:(CGFloat)width {
    [[NSUserDefaults standardUserDefaults] setFloat:(float)width forKey: UserDefault_ClusterItemWidth];
}
+ (CGFloat)getClusterItemWidth {
    
    NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
    CGFloat width = (CGFloat)[defaults floatForKey:UserDefault_ClusterItemWidth];
